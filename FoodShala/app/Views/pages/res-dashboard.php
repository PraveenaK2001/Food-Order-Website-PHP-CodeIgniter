...
<div class="card w-75">
  <div class="card-body">
    <h5 class="card-title">Order Id: &nbsp;<?=$Item['orderId']?>&nbsp;by&nbsp;Customer Id:&nbsp;<?=$Item['CustId']?><br><small>Item Id: &nbsp;<?=$Item['itemId']?></small>&nbsp;&nbsp;<small>Item Name: &nbsp;<?=$Item['IName']?></small>&nbsp;&nbsp;<small>Customer Id: &nbsp; <?=$Item['CustId']?></small>

     &nbsp;<small><a href="
<?='/FoodShala/public/mark-deliver/'.$Item['orderId']?>

      " class="btn btn-primary">Mark Delivered</a></small> 
